        ...
        <body style="background-color: #4267b2;">
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper" style="background-color: #4267b2;">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: #fff;"><i class=" fa fa-key fa fa-key"></i> Niveles de Acceso</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-green">
                                <div class="panel-heading" style="font-size: 23px;">Lista de Niveles de Acceso</div>
                                <div class="panel-body">
                                    <div class="row" style="margin-bottom: 20px;">
                                        <div class="col-md-3 col-md-offset-10">
                                            <button type="button" class="btn btn-primary" id="nuevo_nivel" style="margin-left: 34px; color: #fff;">Agregar Nivel <i class="fa fa-key" style="color: #fff;"> </i></button>  
                                        </div>
                                    </div>                            
                                    <div class="row">
                                        <div class="col-md-12">
                                        <table  width="100%" class="table table-striped table-bordered table-hover" id="resultados">
                                                ...
                                                <thead><tr><th style="text-align:center">Orden</th><th style="text-align:center">Nivel</th><th style="text-align:center">Editar</th></thead><tbody>

                                                <?php
                                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                                  <tr ><td style="text-align:center"><?php echo $row['id']; ?></td>
            ...
            <script>
             ...
             $("#nuevo_nivel").click(function () {
                swal({
                title: 'Agrega un Nuevo Nivel',
                input: 'text',
                inputPlaceholder: 'Ingrese Aquí el Nuevo Nivel de Acceso',
                customClass: 'swal-wide-2',
 showCancelButton: true,
                confirmButtonText: 'Agregar Nivel',
  ...
  preConfirm: function (text) {
    return new Promise(function (resolve, reject) {
      setTimeout(function() {
        if(text != '') {
        if (text === text) {
          var agente_creador = <?php echo $agente ['id']; ?>;
     window.location.href = 'agregar_nivel.php?nivel='+text+'&agente_creador='+agente_creador;
} else {
          resolve()
        }
          ...
          swal(
    'El Nivel de Acceso No Fue Agregado!',
    'Debe Ingresar Datos Para Poder Agregar el Nivel de Acceso!', 
    'error'
  )
        }
  ...
  allowOutsideClick: false
    ...
    swal(
    'Nivel de Acceso Agregado!',
    'El nuevo nivel de acceso ha sido agregado con éxito!', 
    'success'
  )
});
                    });

             var nivel_agregado = <?php echo $nivel_agregado; ?>;

  if(nivel_agregado == 1){
    swal(
    'Nuevo Nivel de Acceso Agregado!',
    'El nuevo nivel de acceso ha sido agregado con éxito!',
    'success'
  )
  }
